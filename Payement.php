...
if ($search != '') {
    ...
    $Sql2 .= " AND (
        ...
        OR p.Date_payement LIKE :search
         OR e.Mention LIKE :search
    ) ";
...
<head>
    <link rel="stylesheet" href="Payement.css?v=<?= time() ?>">
    <link rel="stylesheet"
            ...
            <div class="table-card">
                ...
                <div class="table-header">
                    ...
                    <form method="GET" class="search-box">
                        ...
                        <input type="text"
                            name="search"
                            placeholder="IM, nom, prénom, mention ou date..."
                            value="<?= $_GET['search'] ?? '' ?>">
                            ...
                            <?php foreach ($Payement as $p) { ?>
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        <a href="Payement.php?id=<?= $p['Id'] ?>" class="icon edit" title="Modifier paiement">
                                        ...
                                        <a href="reçu.php?id=<?= $p['Id'] ?>" target="_blank" class="icon recu" title="Imprimer reçu">
